...
<?php echo form_open_multipart('transaction/sell',array('id'=>'form_sell','data-role' =>  'validator','data-on-error-input' => 'notifyOnErrorInput','data-show-error-hint' => 'false')) ?>
<div class="container">
	<div class="grid">
		<div class="row">
	        <div class="cell">
	    ...
	    <div class="row cells2">
	    	<div class="cell">
	    		<div class="input-control text full-size">
                    <input type="text" value="<?php echo $sale_code ?>" readonly="readonly">
                </div>
	    	</div>
	    	<div class="cell">
