					...
					<tbody>
						<?php if($member_point!=NULL): ?>
							...
							<tr>
								...
								<td><a href="<?php echo base_url('configuration/edit_member_point/'.$row->id) ?>"><span class="mif mif-pencil"></span> Edit</a> - <a href="#" onclick="delete_target('<?php echo $row->id ?>')"><span class="mif mif-bin"></span> Hapus</a></td>
							</tr>
							<?php $i++; ?>
							<?php endforeach; ?>
						<?php else: ?>
